...
export function exportarReporteExcel(reporte: ReporteVentas) {
  ...
  const datos = [
    ...
    [
      'Premium',
      `$${(reporte.premium.precio || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      (reporte.premium.litros || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      `$${(reporte.premium.importe || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      (reporte.premium.mermaVolumen || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      `$${(reporte.premium.mermaImporte || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      `${(reporte.premium.mermaPorcentaje || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}%`,
    ...
    [
      'Magna',
      `$${(reporte.magna.precio || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      (reporte.magna.litros || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      `$${(reporte.magna.importe || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      (reporte.magna.mermaVolumen || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      `$${(reporte.magna.mermaImporte || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      `${(reporte.magna.mermaPorcentaje || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}%`,
    ...
    [
      'Diesel',
      `$${(reporte.diesel.precio || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      (reporte.diesel.litros || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      `$${(reporte.diesel.importe || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      (reporte.diesel.mermaVolumen || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      `$${(reporte.diesel.mermaImporte || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      `${(reporte.diesel.mermaPorcentaje || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}%`,
    ...
    [
      ...
      totalMermaVolumen.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      `$${totalMermaImporte.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      totalMermaVolumen > 0
        ...
        : '0.00%',
      volumenNeto.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      `$${importeNeto.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
    ],
    [''],
    ['='.repeat(100)],
    ...
    [
      'TOTALES',
      totalIIB.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      totalCompras.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      totalCCT.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      totalVDsc.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      totalDC.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      totalDifVDsc.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      totalIF.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      totalIFFB.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
    ],
    [''],
    ['='.repeat(100)],
    ['RESUMEN EJECUTIVO'],
    ...
    [''],
    ['Concepto', 'Valor'],
    ['Total de Ventas (Combustibles)', `$${totalVentas.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`],
    ['Aceites y Lubricantes', `$${(reporte.aceites || 0).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`],
    [
      'TOTAL GENERAL DE VENTAS',
      `$${(totalVentas + (reporte.aceites || 0)).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
    ],
    [''],
    ['Total Litros Vendidos', `${totalLitros.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} L`],
    ['Total Merma Volumen', `${totalMermaVolumen.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} L`],
    ['Volumen Neto', `${volumenNeto.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} L`],
    ['Total Merma Importe', `$${totalMermaImporte.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`],
    ['Importe Neto', `$${importeNeto.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`],
    [''],
