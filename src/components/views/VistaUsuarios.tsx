            ...
            <table className="w-full text-left text-sm text-[#617589] dark:text-slate-400">
              <thead className="bg-gray-50 dark:bg-[#101922] text-xs uppercase text-[#617589] dark:text-slate-500 font-bold">
                <tr>
                  ...
                  <th className="px-6 py-4" scope="col">Rol</th>
                  <th className="px-6 py-4" scope="col">Estaciones</th>
                  <th className="px-6 py-4" scope="col">Zonas</th>
                  <th className="px-6 py-4 text-right" scope="col">Fecha Creación</th>
